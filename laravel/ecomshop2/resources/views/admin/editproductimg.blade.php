                ...
                <div class="card-body">
                    <form action="{{ route('updateproductimg') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img style="height: 400px" src="{{ asset($productinfo->product_img) }}" alt="">
                            </div>
                        </div>

                        <input type="hidden" name="id" id="" value="{{ $productinfo->id }}">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-primary">Change Product Image</button>
                            </div>
                        </div>
                    </form>
                </div>
